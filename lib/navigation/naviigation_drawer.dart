...
import 'package:lsp/navigation/drawer_item.dart';
...
class NavigationDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Drawer(
      child: Material(
        color: Color.fromARGB(255, 67, 18, 202),
        child: Padding(
    ...
    return Row(
      children: [
        const CircleAvatar(
          ...
          backgroundColor: Color.fromARGB(255, 6, 140, 75),
        ),
        const SizedBox(
          width: 20,
        ),
        Column(
          ...
          children: const [
            Text('Barath', style: TextStyle(fontSize: 14, color: Colors.white)),
            SizedBox(
              height: 10,
            ),
            Text('Barath@email.com',
